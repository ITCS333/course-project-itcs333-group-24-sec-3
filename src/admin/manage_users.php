                ...
                <form action="#" method="post" class="mt-3" novalidate>
                    ...
                    <fieldset class="card p-4 shadow-sm border-0">
                        ...
                        <!-- TODO: Add a 'label' and 'input' for the default password.
                             ...
                             - input 'type': "text"
                             - You can pre-fill this with a value like "***REMOVED***" or leave it blank. -->
                        <label class="form-label" for="default-password">Default Password:</label>
                        <input type="text" name="default_password" id="default-password" value="<?= htmlspecialchars($_POST['default_password'] ?? '***REMOVED***', ENT_QUOTES, 'UTF-8') ?>" class="form-control mb-4">
                        <!-- TODO: Add a 'button' to submit the form.
                             - type="submit"
                             - id="add"
                             - Text: "Add Student" -->
